...
; Used Project 5 template and the powerpoint/handouts
...
.code
    ...
    Decrypt proc
        ...
        L:
            ...
            add al, 65                      ; get the "order" of the character ( A=0, B=1, C=2, ... , Z=25)
            mov bl, key[edi]                ; (2) move the key ASCII character into bl
            sub al, 65                      ; (3) get the "order" of the character ( A=0, B=1, C=2, ... , Z=25)
